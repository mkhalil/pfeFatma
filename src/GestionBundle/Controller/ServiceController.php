...
class ServiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $services = $em->getRepository('GestionBundle:Service')->findAll();
    ...
    {
        $service = new Service();
        $form = $this->createForm('GestionBundle\Form\ServiceType', $service);
    ...
    {
       // $deleteForm = $this->createDeleteForm($service);
        $editForm = $this->createForm('GestionBundle\Form\ServiceType', $service);
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $site = $em->getRepository('GestionBundle:Service')->find($id);
        $em = $this->getDoctrine()->getManager();
        $em->remove($site);
        $em->flush($site);
        $this->addFlash(
